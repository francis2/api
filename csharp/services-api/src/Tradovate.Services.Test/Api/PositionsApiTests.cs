...
namespace Tradovate.Services.Test
{
    ...
    public class PositionsApiTests
    {
        ...
        /// <summary>
        /// Test GetAllPositionLogs
        /// </summary>
        [Test]
        public void GetAllPositionLogsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetAllPositionLogs();
            //Assert.IsInstanceOf<List<PositionLog>> (response, "response is List<PositionLog>");
        }
        ...
        /// <summary>
        /// Test GetOwnedPositionLogs
        /// </summary>
        [Test]
        public void GetOwnedPositionLogsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? masterid = null;
            //var response = instance.GetOwnedPositionLogs(masterid);
            //Assert.IsInstanceOf<List<PositionLog>> (response, "response is List<PositionLog>");
        }
        
        /// <summary>
        /// Test GetOwnedPositionLogsBatch
        /// </summary>
        [Test]
        public void GetOwnedPositionLogsBatchTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //List<int?> masterids = null;
            //var response = instance.GetOwnedPositionLogsBatch(masterids);
            //Assert.IsInstanceOf<List<PositionLog>> (response, "response is List<PositionLog>");
        }
        ...
        /// </summary>
        [Test]
        public void GetPositionLogTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //int? id = null;
            //var response = instance.GetPositionLog(id);
            //Assert.IsInstanceOf<PositionLog> (response, "response is PositionLog");
        }
        
        /// <summary>
        /// Test GetPositionLogs
        /// </summary>
        [Test]
        public void GetPositionLogsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //List<int?> ids = null;
            //var response = instance.GetPositionLogs(ids);
            //Assert.IsInstanceOf<List<PositionLog>> (response, "response is List<PositionLog>");
        }
