...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetProductFeeParams :  IEquatable<GetProductFeeParams>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProductFeeParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetProductFeeParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetProductFeeParams" /> class.
        /// </summary>
        /// <param name="ProductIds">ProductIds (required).</param>
        public GetProductFeeParams(List<int?> ProductIds = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetProductFeeParams);
        }

        /// <summary>
        /// Returns true if GetProductFeeParams instances are equal
        /// </summary>
        /// <param name="other">Instance of GetProductFeeParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetProductFeeParams other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
