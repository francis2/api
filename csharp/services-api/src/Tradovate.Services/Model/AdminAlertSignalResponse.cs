...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AdminAlertSignalResponse :  IEquatable<AdminAlertSignalResponse>
    {
        /// <summary>
        ...
        public AdminAlertSignalResponse(string ErrorText = null, AdminAlertSignal AdminAlertSignal = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AdminAlertSignalResponse);
        }

        /// <summary>
        /// Returns true if AdminAlertSignalResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of AdminAlertSignalResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdminAlertSignalResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.AdminAlertSignal == other.AdminAlertSignal ||
                    this.AdminAlertSignal != null &&
                    this.AdminAlertSignal.Equals(other.AdminAlertSignal)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.AdminAlertSignal != null)
                    hash = hash * 59 + this.AdminAlertSignal.GetHashCode();
                return hash;
            }
        }
    }
