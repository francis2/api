...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlaceOrderResult :  IEquatable<PlaceOrderResult>
    {
        /// <summary>
        ...
        public PlaceOrderResult(FailureReasonEnum? FailureReason = null, string FailureText = null, int? OrderId = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PlaceOrderResult);
        }

        /// <summary>
        /// Returns true if PlaceOrderResult instances are equal
        /// </summary>
        /// <param name="other">Instance of PlaceOrderResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlaceOrderResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
