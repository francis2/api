...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModifyOrderStrategy :  IEquatable<ModifyOrderStrategy>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyOrderStrategy" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ModifyOrderStrategy() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifyOrderStrategy" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ModifyOrderStrategy);
        }

        /// <summary>
        /// Returns true if ModifyOrderStrategy instances are equal
        /// </summary>
        /// <param name="other">Instance of ModifyOrderStrategy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyOrderStrategy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
