...
namespace Tradovate.Services.Model
{
    ...
    public partial class ChatMessageResponse :  IEquatable<ChatMessageResponse>
    {
        ...
        public ChatMessageResponse(string ErrorText = null, ChatMessage ChatMessage = null)
        {
        ...
        public bool Equals(ChatMessageResponse other)
        {
            ...
            return 
                ...
                (
                    this.ChatMessage == other.ChatMessage ||
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ChatMessage != null)
                    hash = hash * 59 + this.ChatMessage.GetHashCode();
                return hash;
            }
        }
    }
