        ...
        public bool Equals(Position other)
        {
            ...
            return 
                ...
                (
                    ...
                    this.PrevPos != null &&
                    this.PrevPos.Equals(other.PrevPos)
                ) && 
                (
                    this.PrevPrice == other.PrevPrice ||
                    this.PrevPrice != null &&
                    this.PrevPrice.Equals(other.PrevPrice)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrevPos != null)
                    hash = hash * 59 + this.PrevPos.GetHashCode();
                if (this.PrevPrice != null)
                    hash = hash * 59 + this.PrevPrice.GetHashCode();
                return hash;
            }
        }
    }
