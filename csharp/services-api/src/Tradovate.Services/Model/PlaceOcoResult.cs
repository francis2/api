...
namespace Tradovate.Services.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PlaceOcoResult :  IEquatable<PlaceOcoResult>
    {
        /// <summary>
        ...
        public PlaceOcoResult(FailureReasonEnum? FailureReason = null, string FailureText = null, int? OrderId = null, int? OcoId = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PlaceOcoResult);
        }

        /// <summary>
        /// Returns true if PlaceOcoResult instances are equal
        /// </summary>
        /// <param name="other">Instance of PlaceOcoResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PlaceOcoResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
