...
namespace Tradovate.Services.Api
{
    ...
    public interface IAccountingApi : IApiAccessor
    {
        ...
        ApiResponse<CashBalanceSnapshot> ChangeDemoBalanceWithHttpInfo (ChangeDemoBalance body);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<List<CashBalanceLog>> GetAllCashBalanceLogsWithHttpInfo ();
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<CashBalanceSnapshot> ChangeDemoBalanceAsync (ChangeDemoBalance body);
        ...
        System.Threading.Tasks.Task<ApiResponse<CashBalanceSnapshot>> ChangeDemoBalanceAsyncWithHttpInfo (ChangeDemoBalance body);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<CashBalanceLog>> GetAllCashBalanceLogsAsync ();
        ...
        System.Threading.Tasks.Task<ApiResponse<List<CashBalanceLog>>> GetAllCashBalanceLogsAsyncWithHttpInfo ();
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class AccountingApi : IAccountingApi
    {
        ...
        /// <param name="body"></param>
        /// <returns>CashBalanceSnapshot</returns>
        public CashBalanceSnapshot ChangeDemoBalance (ChangeDemoBalance body)
        {
             ApiResponse<CashBalanceSnapshot> localVarResponse = ChangeDemoBalanceWithHttpInfo(body);
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of CashBalanceSnapshot</returns>
        public ApiResponse< CashBalanceSnapshot > ChangeDemoBalanceWithHttpInfo (ChangeDemoBalance body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling AccountingApi->ChangeDemoBalance");

            var localVarPath = "/cashBalance/changedemobalance";
            ...
            {
                Exception exception = ExceptionFactory("ChangeDemoBalance", localVarResponse);
        ...
        /// <param name="body"></param>
        /// <returns>Task of CashBalanceSnapshot</returns>
        public async System.Threading.Tasks.Task<CashBalanceSnapshot> ChangeDemoBalanceAsync (ChangeDemoBalance body)
        {
             ApiResponse<CashBalanceSnapshot> localVarResponse = await ChangeDemoBalanceAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body"></param>
        /// <returns>Task of ApiResponse (CashBalanceSnapshot)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CashBalanceSnapshot>> ChangeDemoBalanceAsyncWithHttpInfo (ChangeDemoBalance body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling AccountingApi->ChangeDemoBalance");
        ...
        /// <exception cref="Tradovate.Services.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>List&lt;CashBalanceLog&gt;</returns>
        public List<CashBalanceLog> GetAllCashBalanceLogs ()
        {
             ApiResponse<List<CashBalanceLog>> localVarResponse = GetAllCashBalanceLogsWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="Tradovate.Services.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;CashBalanceLog&gt;</returns>
        public ApiResponse< List<CashBalanceLog> > GetAllCashBalanceLogsWithHttpInfo ()
        {

            var localVarPath = "/cashBalanceLog/list";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetAllCashBalanceLogs", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <exception cref="Tradovate.Services.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;CashBalanceLog&gt;</returns>
        public async System.Threading.Tasks.Task<List<CashBalanceLog>> GetAllCashBalanceLogsAsync ()
        {
             ApiResponse<List<CashBalanceLog>> localVarResponse = await GetAllCashBalanceLogsAsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="Tradovate.Services.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;CashBalanceLog&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<CashBalanceLog>>> GetAllCashBalanceLogsAsyncWithHttpInfo ()
        {
